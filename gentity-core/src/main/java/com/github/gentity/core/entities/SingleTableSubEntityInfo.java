...
public class SingleTableSubEntityInfo extends EntityInfo<SingleTableSubEntityInfo> {
	...
	public SingleTableSubEntityInfo(String name, TableDto baseTable, FieldColumnSource fieldColumnSource, EntityInfo parentEntityInfo, String discriminatorValue) {
